...
public class config {
  ...
  public static String getAllData()
  {
    ...
    try {
      ...
      String query = "SELECT no_faktur, nama_barang,harga_barang FROM mini_market";
...
public static boolean tambahData( String no_faktur, String nama_customer, String nama_barang, double harga_barang, int jumlah_barang, String noHP, String alamat )
  {
    config.connection();
    boolean data = false;
    ...
    try {
      ...
      String query = "INSERT INTO minimarket VALUES ('" + no_faktur + "', '" + nama_customer + "', '" + noHP + "', '" + alamat + "', '" + nama_barang + "', " + harga_barang + ", " + jumlah_barang + ")";
...
public static boolean deleteData( int invoiceNumber )
  {
    ...
    try {
      ...
      String query = "DELETE FROM mini_market WHERE no_faktur = " + invoiceNumber;
...
public static boolean updateData( int invoiceNumber, String itemName, int quantity, int price )
  {
    ...
    try {
      ...
      String queryCek = "SELECT * FROM mini_market WHERE no_faktur = " + invoiceNumber;
      ...
      String queryUpdate = "UPDATE mini_market SET nama_barang = '" + namaCek + "', jumlah_barang = " + stokCek + ", harga_barang = " + hargaCek + " WHERE no_faktur = " + invoiceNumber ;
