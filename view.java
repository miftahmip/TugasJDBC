...
public class view {
  ...
  public static void tambahData()
  {
    ...
    Scanner scanner = new Scanner(System.in);
                    ...
                    System.out.println("Nomor Faktur\t\t: " + invoice.getNo_faktur());
                    System.out.println("==========Data Pelanggan==========");
                    System.out.println("Nama Pelanggan\t\t: " + invoice.getNama_customer());
                    System.out.println("No Handphone\t\t: " + invoice.getNoHP());
                    System.out.println("Alamat\t\t\t: " + invoice.getAlamat());
                    System.out.println("============Data Barang============");
                    System.out.println("Nama Barang\t\t: " + invoice.getNama_barang());
                    System.out.println("Harga Barang\t\t: " + invoice.getHarga_barang());
                    System.out.println("Jumlah Barang\t\t: " + invoice.getJumlah_Barang());
                    System.out.println("Total Bayar\t\t: " + invoice.calculateTotal());
                    System.out.println("===============Kasir===============");
                    String myString = "yaya";
